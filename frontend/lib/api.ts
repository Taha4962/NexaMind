/**
 * NexaMind Frontend — Typed Axios Instance & Streaming Utility
 *
 ...
 * Also provides streamChat async generator for SSE streaming from Next.js gateway.
 */
...
/**
 * Request interceptor: injects the JWT access token from memory / session.
 */
